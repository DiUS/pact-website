...
$(document).ready(function() {
  ...
  if ($("#show-map").length > 0) {
    document.getElementById("show-map").onclick = function() {
      ...
      if (map.className === "hide") {
        ...
        document.getElementById("show-map").className =
          "pe-7s-map-marker activa";
      }
  ...
  $("#typed").typed({
    strings: [
      "Creative Multipurpose Software Template",
      "Design Templates with Usability.",
  ...
  $("#clock").countdown("2017/08/13", function(event) {
    var $this = $(this).html(
      event.strftime(
        "" +
          '<span>%-D <p class="clock"> day%!D </p></span>' +
          '<span >%H <p class="clock"> hour%!D</p></span> ' +
          '<span>%M <p class="clock"> minute%!D</p></span> ' +
          '<span>%S <p class="clock"> second%!D</p></span>'
      )
    );
  });
